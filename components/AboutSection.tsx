          ...
          <div className="space-y-12">
            <div className="reveal">
              ...
              <div className="space-y-8 text-lg font-light leading-loose">
                <p>
                  I believe in the power of simplicity. Every line of code should serve a purpose, 
                  every interface should feel intuitive, and every solution should be elegant.
                </p>
                <p>
                  My approach combines technical precision with creative thinking, 
                  resulting in software that not only works flawlessly but also 
                  brings joy to those who use it.
                </p>
              </div>
            </div>

            <div className="reveal">
              <h3 className="text-2xl font-light mb-8 japanese-heading">Expertise</h3>
                  ...
                  <div className="grid grid-cols-2 gap-8">
                    {[
                      ...
                      <div key={index} className="text-center">
                        <div className="text-3xl font-thin japanese-heading mb-2">{stat.number}</div>
                        <div className="text-xs font-light tracking-widest opacity-60">{stat.label}</div>
                      </div>
                    ))}
                  </div>
